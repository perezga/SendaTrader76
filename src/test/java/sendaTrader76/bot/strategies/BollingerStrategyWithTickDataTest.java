...
public class BollingerStrategyWithTickDataTest {
	...
	public void BollingerStrategyTest() {
		...
		//candleService.setCandleHistory(candleService.getCandles(InstrumentType.EUR_USD, 25, GranuarityType.M1, CandleFormat.M, "2016-11-07T17:22:00.000000000Z"));
		...
		try (BufferedReader br = Files.newBufferedReader(
			...
			//expected
			// StrategyResults [startDate=null, endDate=null, balance=-0.001840, totalLoss=-0.002780, totalWin=0.00094, totalPositions=13, numWinPosition=3, numLosePositions=10]

			//actual
			//StrategyResults [startDate=null, endDate=null, balance=-0.001370, totalLoss=-0.001670, totalWin=0.00030, totalPositions=11, numWinPosition=2, numLosePositions=9]

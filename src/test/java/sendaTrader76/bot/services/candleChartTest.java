...
public class candleChartTest {
	...
	public void setup() {
		...
		Candle candle0 = createCandle(new BigDecimal("0"), new BigDecimal("0"), new BigDecimal("0"),
				new BigDecimal("0"), true);
		Candle candle1 = createCandle(new BigDecimal("1"), new BigDecimal("1"), new BigDecimal("1"),
				new BigDecimal("1"), true);
		Candle candle2 = createCandle(new BigDecimal("2"), new BigDecimal("2"), new BigDecimal("2"),
				new BigDecimal("2"), true);
		Candle candle3 = createCandle(new BigDecimal("3"), new BigDecimal("3"), new BigDecimal("3"),
				new BigDecimal("3"), true);
		Candle candle4 = createCandle(new BigDecimal("4"), new BigDecimal("4"), new BigDecimal("4"),
		...
		Assertions.assertEquals(8, candleChart.getLastCandle().getTime().getMinute());
	}
	...
	public void getCachedCandlesTest() {
		...
		Assertions.assertEquals(3, candle.size());

		Assertions.assertEquals(new BigDecimal("1"), candle.get(0).getMid().getO());
		Assertions.assertEquals(new BigDecimal("2"), candle.get(1).getMid().getO());
		Assertions.assertEquals(new BigDecimal("3"), candle.get(2).getMid().getO());
	}
